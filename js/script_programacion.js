...
function filtrarYOrdenarProyectos() {
  let proyectosFiltrados = proyectos.filter((p) => p.mencion === "programacion");
  if (terminoBusqueda) {
    ...
    div.innerHTML = `
            ...
            <div class="proyecto-info">
                ...
                <div class="proyecto-footer">
                  ...
                  ${p.enlace ? `<a class="btn btn-small" href="${p.enlace}" target="_blank" rel="noopener">Ver más</a>` : `<button class="btn btn-small" onclick="verProyecto(${p.id})">Ver más</button>`}
                </div>
            </div>
        `;
